#!/usr/bin/env bash
# setup.sh — Deploy kitchen-sink Claude Code configuration to a project
#
...
echo "=== Claude Code Bootstrap — Kitchen Sink Setup ==="
echo "Target: $TARGET"
echo ""
...
# === Custom Commands ===
for f in verify-context load-module load-workflow read-all-context start-design-session load-design-phase finalize-design; do
